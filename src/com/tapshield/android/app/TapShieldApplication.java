...
public class TapShieldApplication extends Application {
	...
	public static JavelinConfig JAVELIN_CONFIG =
			...
			.masterToken("bb83910a015cb8a06bc62a723bf63fa969792acd")
			.gcmSenderId("1074056631619")
			.awsSqsAccessKey("AKIAJDLBPGLRJA4MOMVQ")
			.awsSqsSecretKey("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")
			.awsSqsQueueName("alert_queue_prod")
			.awsDynamoDbAccessKey("AKIAJ34SY3EAOK6STBBA")
			.awsDynamoDbSecretKey("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")
			.awsDynamoDbTable("chat_messages_prod")
			.awsS3AccessKey("AKIAJHIUM7YWZW2T2YIA")
			.awsS3SecretKey("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")
			.awsS3Bucket("media-tapshield-com")
			.build();
